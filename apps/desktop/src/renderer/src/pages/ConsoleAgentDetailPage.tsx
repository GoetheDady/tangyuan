    ...
    window.api
      ...
      .then((records) => {
        ...
        const filtered = records.filter(
          (record) =>
            record.source === 'shared' || record.targetAgentId === agentId,
        )
        ...
        {!agent ? (
          ...
          <div className="space-y-6">
            <div className="bg-card rounded-lg border p-6">
              <h2 className="text-section-heading mb-4 font-semibold">
                基本信息
              </h2>
              <dl className="text-body space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-mono max-w-[300px] truncate">
                    {agent.agentId}
                  </dd>
                </div>
                <div className="flex justify-between">
                  ...
                  <dd className="w-[240px]">
                    {isEditable ? (
                      <Select
                        ...
                        disabled={isSaving}
                      >
                        <SelectTrigger className="text-label h-8">
            ...
            <div className="bg-card rounded-lg border p-6">
              ...
              {isLoadingSkills ? (
                ...
                <div className="bg-muted/50 rounded-md px-4 py-8 text-center">
                  <div className="bg-muted mx-auto mb-3 grid size-10 place-items-center rounded-full">
                    <Puzzle
                      size={18}
                      className="text-muted-foreground"
                      aria-hidden="true"
                  ...
                  <p className="text-label text-muted-foreground mt-1">
                    将 Skill 目录放入 Agent 专属或共享 Skills
                    目录后即可在此查看。
                  </p>
                </div>
              ) : (
                <ul className="divide-y">
                  {skills.map((skill) => (
                    ...
                    >
                      <div className="bg-muted mt-0.5 grid size-7 shrink-0 place-items-center rounded">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant={
                              skill.source === 'agent' ? 'default' : 'secondary'
                            }
                            className="shrink-0"
                          >
            ...
            <div className="bg-card rounded-lg border p-6">
              ...
              {!installRecords || installRecords.length === 0 ? (
                <div className="bg-muted/50 rounded-md px-4 py-6 text-center">
                  <p className="text-body text-muted-foreground">
                    暂无安装记录
                  </p>
                  <p className="text-label text-muted-foreground mt-1">
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              确定归档 Agent「{agent?.displayName}」吗？归档后该 Agent
