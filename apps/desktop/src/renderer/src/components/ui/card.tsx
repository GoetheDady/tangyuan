...
type CardProps =
  StaticCardProps | InteractiveCardProps | InteractiveChildCardProps

type CardComponent = {
  (
    props: StaticCardProps & React.RefAttributes<HTMLDivElement>,
  ): React.ReactElement | null
  (
    props: InteractiveCardProps & React.RefAttributes<HTMLButtonElement>,
  ): React.ReactElement | null
  (
    props: InteractiveChildCardProps & React.RefAttributes<HTMLElement>,
  ): React.ReactElement | null
  displayName?: string
}
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      'border-split flex flex-col gap-1.5 border-b p-[var(--card-padding)]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      'border-split flex items-center justify-end gap-2 border-t p-[var(--card-padding)]',
      className,
    )}
    {...props}
  />
